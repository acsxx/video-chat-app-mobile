              ...
              ({values, handleSubmit, handleChange}) => (
                <View>
                  <View style={style.item}>
                    <TextInput value={values.email} onChangeText={handleChange("email")} placeholder={"Email"} style={style.input} />
                  </View>
                  <View style={style.item}>
                    <TextInput value={values.password} onChangeText={handleChange("password")} placeholder={"Password"} style={style.input} />
                  </View>
                  <View
                    style={[
                      style.item,
